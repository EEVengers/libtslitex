//--------------------------------------------------------------------------------
// Auto-generated by LiteX (a1ea5a2f6) on 2026-03-28 17:56:54
//--------------------------------------------------------------------------------
...
#define CSR_ADC_CONTROL_COUNT_RESET_OFFSET 8
#define CSR_ADC_CONTROL_COUNT_RESET_SIZE 1
...
/* EVENTS Registers */
#define CSR_EVENTS_BASE (CSR_BASE + 0x9000L)
#define CSR_EVENTS_ENGINE_CONTROL_ADDR (CSR_BASE + 0x9000L)
#define CSR_EVENTS_ENGINE_CONTROL_SIZE 1
#define CSR_EVENTS_ENGINE_STATUS_ADDR (CSR_BASE + 0x9004L)
#define CSR_EVENTS_ENGINE_STATUS_SIZE 1
#define CSR_EVENTS_ENGINE_EVENT_ADDR (CSR_BASE + 0x9008L)
#define CSR_EVENTS_ENGINE_EVENT_SIZE 1
#define CSR_EVENTS_ENGINE_FIFO_READSOURCE_ADDR (CSR_BASE + 0x900cL)
#define CSR_EVENTS_ENGINE_FIFO_READSOURCE_SIZE 1
#define CSR_EVENTS_ENGINE_FIFO_READMARKER_ADDR (CSR_BASE + 0x9010L)
#define CSR_EVENTS_ENGINE_FIFO_READMARKER_SIZE 2
#define CSR_EVENTS_GENERATOR_CONTROL_ADDR (CSR_BASE + 0x9018L)
#define CSR_EVENTS_GENERATOR_CONTROL_SIZE 1
#define CSR_EVENTS_GENERATOR_TIMEOUT_ADDR (CSR_BASE + 0x901cL)
#define CSR_EVENTS_GENERATOR_TIMEOUT_SIZE 1
#define CSR_EVENTS_EXT_SYNC_CONTROL_ADDR (CSR_BASE + 0x9020L)
#define CSR_EVENTS_EXT_SYNC_CONTROL_SIZE 1
#define CSR_EVENTS_EXT_SYNC_PULSE_LEN_ADDR (CSR_BASE + 0x9024L)
#define CSR_EVENTS_EXT_SYNC_PULSE_LEN_SIZE 1
#define CSR_EVENTS_EXT_SYNC_STATUS_ADDR (CSR_BASE + 0x9028L)
#define CSR_EVENTS_EXT_SYNC_STATUS_SIZE 1

/* EVENTS Fields */
#define CSR_EVENTS_ENGINE_CONTROL_IN_EN_MASK_OFFSET 0
#define CSR_EVENTS_ENGINE_CONTROL_IN_EN_MASK_SIZE 12
#define CSR_EVENTS_ENGINE_CONTROL_OUT_EN_MASK_OFFSET 16
#define CSR_EVENTS_ENGINE_CONTROL_OUT_EN_MASK_SIZE 12
#define CSR_EVENTS_ENGINE_CONTROL_SYNC_SEL_OFFSET 30
#define CSR_EVENTS_ENGINE_CONTROL_SYNC_SEL_SIZE 1
#define CSR_EVENTS_ENGINE_CONTROL_EVENT_FLUSH_OFFSET 31
#define CSR_EVENTS_ENGINE_CONTROL_EVENT_FLUSH_SIZE 1
#define CSR_EVENTS_ENGINE_STATUS_IN_STAT_OFFSET 0
#define CSR_EVENTS_ENGINE_STATUS_IN_STAT_SIZE 12
#define CSR_EVENTS_ENGINE_EVENT_PENDING_OFFSET 0
#define CSR_EVENTS_ENGINE_EVENT_PENDING_SIZE 1
#define CSR_EVENTS_ENGINE_FIFO_READSOURCE_SOURCE_OFFSET 0
#define CSR_EVENTS_ENGINE_FIFO_READSOURCE_SOURCE_SIZE 4
#define CSR_EVENTS_ENGINE_FIFO_READSOURCE_ADJUST_OFFSET 8
#define CSR_EVENTS_ENGINE_FIFO_READSOURCE_ADJUST_SIZE 8
#define CSR_EVENTS_GENERATOR_CONTROL_IMMEDIATE_OFFSET 0
#define CSR_EVENTS_GENERATOR_CONTROL_IMMEDIATE_SIZE 1
#define CSR_EVENTS_GENERATOR_CONTROL_PERIODIC_OFFSET 1
#define CSR_EVENTS_GENERATOR_CONTROL_PERIODIC_SIZE 1
#define CSR_EVENTS_EXT_SYNC_STATUS_EVT_IN_OFFSET 0
#define CSR_EVENTS_EXT_SYNC_STATUS_EVT_IN_SIZE 1
#define CSR_EVENTS_EXT_SYNC_STATUS_EVT_OUT_OFFSET 8
#define CSR_EVENTS_EXT_SYNC_STATUS_EVT_OUT_SIZE 1
