//--------------------------------------------------------------------------------
// Auto-generated by LiteX (05ddccb20) on 2025-10-04 10:32:08
//--------------------------------------------------------------------------------
...
#define CSR_SPIFLASH_MMAP_WRITE_CONFIG_ADDR (CSR_BASE + 0x3808L)
#define CSR_SPIFLASH_MMAP_WRITE_CONFIG_SIZE 1
#define CSR_SPIFLASH_MASTER_CS_ADDR (CSR_BASE + 0x380cL)
#define CSR_SPIFLASH_MASTER_CS_SIZE 1
#define CSR_SPIFLASH_MASTER_PHYCONFIG_ADDR (CSR_BASE + 0x3810L)
#define CSR_SPIFLASH_MASTER_PHYCONFIG_SIZE 1
#define CSR_SPIFLASH_MASTER_RXTX_ADDR (CSR_BASE + 0x3814L)
#define CSR_SPIFLASH_MASTER_RXTX_SIZE 1
#define CSR_SPIFLASH_MASTER_STATUS_ADDR (CSR_BASE + 0x3818L)
#define CSR_SPIFLASH_MASTER_STATUS_SIZE 1

/* SPIFLASH Fields */
#define CSR_SPIFLASH_MMAP_WRITE_CONFIG_WRITE_ENABLE_OFFSET 0
#define CSR_SPIFLASH_MMAP_WRITE_CONFIG_WRITE_ENABLE_SIZE 1
