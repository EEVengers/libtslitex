...
#define CSR_ADC_HAD1511_DATA_CHANNELS_ADDR (CSR_BASE + 0x20L)
...
/* FRONTEND Registers */
#define CSR_FRONTEND_BASE (CSR_BASE + 0x1800L)
#define CSR_FRONTEND_CONTROL_ADDR (CSR_BASE + 0x1800L)
...
#define CSR_I2C_PHY_SPEED_MODE_ADDR (CSR_BASE + 0x2000L)
#define CSR_I2C_PHY_SPEED_MODE_SIZE 1
#define CSR_I2C_MASTER_ACTIVE_ADDR (CSR_BASE + 0x2004L)
#define CSR_I2C_MASTER_ACTIVE_SIZE 1
#define CSR_I2C_MASTER_SETTINGS_ADDR (CSR_BASE + 0x2008L)
#define CSR_I2C_MASTER_SETTINGS_SIZE 1
#define CSR_I2C_MASTER_ADDR_ADDR (CSR_BASE + 0x200cL)
#define CSR_I2C_MASTER_ADDR_SIZE 1
#define CSR_I2C_MASTER_RXTX_ADDR (CSR_BASE + 0x2010L)
#define CSR_I2C_MASTER_RXTX_SIZE 1
#define CSR_I2C_MASTER_STATUS_ADDR (CSR_BASE + 0x2014L)
...
#define CSR_LEDS_PWM_ENABLE_ADDR (CSR_BASE + 0x3804L)
#define CSR_LEDS_PWM_ENABLE_SIZE 1
#define CSR_LEDS_PWM_WIDTH_ADDR (CSR_BASE + 0x3808L)
#define CSR_LEDS_PWM_WIDTH_SIZE 1
#define CSR_LEDS_PWM_PERIOD_ADDR (CSR_BASE + 0x380cL)
#define CSR_LEDS_PWM_PERIOD_SIZE 1

/* LEDS Fields */

/* MAIN_SPI Registers */
#define CSR_MAIN_SPI_BASE (CSR_BASE + 0x4000L)
#define CSR_MAIN_SPI_CONTROL_ADDR (CSR_BASE + 0x4000L)
#define CSR_MAIN_SPI_CONTROL_SIZE 1
#define CSR_MAIN_SPI_STATUS_ADDR (CSR_BASE + 0x4004L)
#define CSR_MAIN_SPI_STATUS_SIZE 1
#define CSR_MAIN_SPI_MOSI_ADDR (CSR_BASE + 0x4008L)
#define CSR_MAIN_SPI_MOSI_SIZE 1
#define CSR_MAIN_SPI_MISO_ADDR (CSR_BASE + 0x400cL)
#define CSR_MAIN_SPI_MISO_SIZE 1
#define CSR_MAIN_SPI_CS_ADDR (CSR_BASE + 0x4010L)
#define CSR_MAIN_SPI_CS_SIZE 1
#define CSR_MAIN_SPI_LOOPBACK_ADDR (CSR_BASE + 0x4014L)
